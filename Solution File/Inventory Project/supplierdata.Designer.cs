...
namespace Inventory_Project {
    ...
    public partial class supplierdata : global::System.Data.DataSet {
        ...
        public partial class SuppliersDataTable : global::System.Data.TypedTableBase<SuppliersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public SuppliersRow AddSuppliersRow(string SupplierName, string SupplierPhone, string SupplierAddress) {
            ...
            private void InitClass() {
                ...
                this.columnSupplierPhone.MaxLength = 40;
...
namespace Inventory_Project.supplierdataTableAdapters {
    ...
    public partial class SuppliersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Suppliers] WHERE (([SupplierID] = @Original_SupplierID) AND ([SupplierName] = @Original_SupplierName) AND ([SupplierPhone] = @Original_SupplierPhone) AND ((@IsNull_SupplierAddress = 1 AND [SupplierAddress] IS NULL) OR ([SupplierAddress] = @Original_SupplierAddress)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Suppliers] ([SupplierName], [SupplierPhone], [SupplierAddress]) VALUES (@SupplierName, @SupplierPhone, @SupplierAddress);
SELECT SupplierID, SupplierName, SupplierPhone, SupplierAddress FROM Suppliers WHERE (SupplierID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Suppliers] SET [SupplierName] = @SupplierName, [SupplierPhone] = @SupplierPhone, [SupplierAddress] = @SupplierAddress WHERE (([SupplierID] = @Original_SupplierID) AND ([SupplierName] = @Original_SupplierName) AND ([SupplierPhone] = @Original_SupplierPhone) AND ((@IsNull_SupplierAddress = 1 AND [SupplierAddress] IS NULL) OR ([SupplierAddress] = @Original_SupplierAddress)));
SELECT SupplierID, SupplierName, SupplierPhone, SupplierAddress FROM Suppliers WHERE (SupplierID = @SupplierID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Inventory_Project.Properties.Settings.Default.LoadDataConnectionString1;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT SupplierID, SupplierName, SupplierPhone, SupplierAddress FROM dbo.Supplier" +
                "s";
        ...
        public virtual int Fill(supplierdata.SuppliersDataTable dataTable) {
        ...
        public virtual supplierdata.SuppliersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            supplierdata.SuppliersDataTable dataTable = new supplierdata.SuppliersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(supplierdata.SuppliersDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(supplierdata dataSet) {
        ...
        public virtual int Delete(int Original_SupplierID, string Original_SupplierName, string Original_SupplierPhone, string Original_SupplierAddress) {
        ...
        public virtual int Insert(string SupplierName, string SupplierPhone, string SupplierAddress) {
        ...
        public virtual int Update(string SupplierName, string SupplierPhone, string SupplierAddress, int Original_SupplierID, string Original_SupplierName, string Original_SupplierPhone, string Original_SupplierAddress, int SupplierID) {
            if ((SupplierName == null)) {
                throw new global::System.ArgumentNullException("SupplierName");
            }
            else {
            ...
            if ((Original_SupplierPhone == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[5].Value = ((string)(Original_SupplierPhone));
            }
            if ((Original_SupplierAddress == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string SupplierName, string SupplierPhone, string SupplierAddress, int Original_SupplierID, string Original_SupplierName, string Original_SupplierPhone, string Original_SupplierAddress) {
            return this.Update(SupplierName, SupplierPhone, SupplierAddress, Original_SupplierID, Original_SupplierName, Original_SupplierPhone, Original_SupplierAddress, Original_SupplierID);
        }
    }
